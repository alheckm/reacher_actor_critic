...
class DDPGAgent():
    ...
    def learn(self, experiences, gamma):
        ...
        torch.nn.utils.clip_grad_norm_(self.critic_local.parameters(), 1.0) # from benchmark implementation
        ...
        torch.nn.utils.clip_grad_norm_(self.actor_local.parameters(), 1.0) # from benchmark implementation
